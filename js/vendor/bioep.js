window.bioEp = {
	...
	addCSS: function() {
		...
		var css = document.createTextNode(
			...
			"#bio_ep_close {position: absolute; left: 100%; margin: -8px 0 0 -10px; width: 20px; height: 20px; color: #fff; font-size: 11px; font-weight: 200; text-align: center; padding-top: 2px;border-radius: 50%; background-color: #1E2C40; cursor: pointer;}" +
			this.css
		);
	...
	loadEvents: function() {
		...
		// Added support for clicking background to quit
